...
ax[0].plot(returns_df["strategy_csum"], label="Strategy Cumulative Returns", color="green")
ax[0].plot(returns_df["full_equity_csum"], label="Full Equity Cumulative Returns", color="blue")
ax[0].plot(returns_df["sixty_forty_csum"], label="60/40 Cumulative Returns", color="red")
ax[1].plot(returns_df["strategy_csum"], label="Strategy Cumulative Returns", color="green")
