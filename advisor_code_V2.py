...
#sidebar text
st.sidebar.write(f"You have a {option} appetite, meaning your risk will be similar to the benchmark. You decided to begin investing with {initial_investment}$, and to contribute monthly with {monthly_contribution}$ during {investment_horizon} year. Finally you expect an annual inflation of {inflation*100}%.")
